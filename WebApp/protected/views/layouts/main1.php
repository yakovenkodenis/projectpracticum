...
<table class="header">
    ...
    <td><img src="<?php echo Yii::app()->getBaseUrl(true);?>/images/logo.png" /></td>
    <td>
        <div class="loginform">
            ...
            <?php $this->endWidget(); ?>
            <?php else:?>
                Добро пожаловать, <?php echo Yii::app()->user->getUserModel()->login ?>
            ...
            'items' => array(
                array(
                    ...
                    'items' => array(
                        ...
                        array('label'=>'Рассписание', 'url'=>array('/user/theory'), 'visible'=>Yii::app()->user->role=="student" || Yii::app()->user->role=="teacher"),
